...
export function createLayoutStore(): EngineStoreHandle<LayoutState, LayoutActions>  {
  const handle = defineStore({
    ...
    actions: {
      ...
      // Light dismiss of the expanded sidebar (tapping outside it on mobile,
      // or Escape): narrow clears the re-expand override, wide rewrites the
      // preference like closeDetails. Symmetric with closeDetails below.
      closeSidebar: (d) => {
